...
const massQueryController = proxyquire("../../controllers/massQueryController", {  //using proxyquire to mock imports in massQueryController
  "./filmController": { search: () => true, list: () => true },
  "./personController": { search: () => true, list: () => true },
  "./speciesController": { search: () => true, list: () => true },
  "./planetController": { search: () => true, list: () => true },
  "./vehicleController": { search: () => true, list: () => true },
  "./starshipController": { search: () => true, list: () => true },
  "./searchController": { search: () => true, list: () => true }
});
const {
  getIdentifier,
  paginateModel,
  ...
  sortModel,
  processModel
} = massQueryController;  //importing from proxyquire
const identifierName = { id: 1, name: "gotName" };
const identifierTitle = { id: 2, title: "gotTitle" };
const identifierTransportName = {
  id: 3,
  Transport: { name: "gotTransportName" }
};
